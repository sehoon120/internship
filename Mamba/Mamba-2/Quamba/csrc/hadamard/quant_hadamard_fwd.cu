...
void fast_hadamard_transform_kernel(HadamardParamsBase params) {
    ...
    int8_t *out = reinterpret_cast<int8_t *>(params.out_ptr) + batch_id * params.out_batch_stride;
    ...
    store_output<kNChunks, kNElts, int8_t>(out, x_vals, params.dim, params.scale);
}
